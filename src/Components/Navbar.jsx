      ...
      <nav className="mx-auto max-w-7xl bg-[#141416]/90 border border-zinc-800/60 backdrop-blur-xl rounded-2xl h-20 flex items-center justify-between px-6 md:px-10 text-white relative shadow-2xl">
        ...
        <div className="flex items-center">
          <a href="/" className="text-2xl font-black tracking-tight flex items-center select-none">
            <Image src={logo} height={30} width={120}/>
          </a>
        </div>
        ...
        <div className="hidden md:flex items-center gap-6">
          <ul className="flex items-center gap-7 text-[14px] font-normal text-zinc-400">
            <li>
              <a href="#" className="hover:text-white transition-colors duration-200">Browse Jobs</a>
            </li>
            <li>
              <a href="#" className="hover:text-white transition-colors duration-200">Company</a>
            </li>
            <li>
          ...
          {/* Exact Vertical Divider Line from Screenshot */}
          <div className="h-4 w-[1px] bg-zinc-800/80 mx-1"></div>

          {/* Auth Button Group */}
          <div className="flex items-center gap-6">
            <a href="#" className="text-[14px] font-medium text-[#5B51F9] hover:text-[#483EFF] transition-colors duration-200">
              Sign In
            </a>
        ...
        {isMenuOpen && (
          <div className="absolute top-[90px] left-0 w-full bg-[#141416] border border-zinc-800/80 rounded-2xl p-6 flex flex-col gap-4 shadow-2xl md:hidden z-50 animate-in fade-in slide-in-from-top-2 duration-150">
            <ul className="flex flex-col gap-4 text-base font-normal text-zinc-300">
              <li>
                <a href="#" className="block py-1 hover:text-white" onClick={() => setIsMenuOpen(false)}>Browse Jobs</a>
              </li>
              <li>
                <a href="#" className="block py-1 hover:text-white" onClick={() => setIsMenuOpen(false)}>Company</a>
              </li>
              <li>
                <a href="#" className="block py-1 hover:text-white" onClick={() => setIsMenuOpen(false)}>Pricing</a>
              </li>
              ...
              <li>
                <a href="#" className="block py-1 text-[#5B51F9] font-semibold" onClick={() => setIsMenuOpen(false)}>Sign In</a>
              </li>
              <li className="pt-2">
                <button className="w-full bg-[#5B51F9] text-white font-medium py-3 rounded-xl text-center block" onClick={() => setIsMenuOpen(false)}>
                  Get Started
                </button>
              </li>
            </ul>
